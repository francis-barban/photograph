...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/images/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/images/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/images/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'/images/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'/images/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
		...
		function _set_interface() {
			...
			//$('#lightbox-nav-btnClose').css({ 'background' : 'url(' + settings.imageBtnClose + ') no-repeat left top' })
